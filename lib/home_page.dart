...
class _HomePageState extends State<HomePage> {
  ...
  popularList(){
    ...
    popList.add(PopularFoodModal(
        ...
        name: "Wings",
        icon: Icons.favorite,
        distance: "0.5 km",likes: "0.2 Likes",rating: 4 ,price: "Price:250/Rs",time: "20-25 min",description: "Chicken wings are typically divided into two sections: the drumette and the flat or wingette. They are prepared by deep-frying, baking, or grilling, with deep-frying being the most common method. One of the defining characteristics of chicken wings is the wide range of sauces and flavors in which they can be coated."));
    popList.add(PopularFoodModal(
        images: "assets/images/burger.png",
        name: "Burger",
        icon: Icons.favorite,
        distance: "1.2 km",likes: "5.2 Likes",rating: 3 ,price: "Price:120/Rs",time: "10-15 min",description: "A burger is a patty of ground beef grilled and placed between two halves of a bun. Slices of raw onion, lettuce, bacon, mayonnaise, and other ingredients add flavor. Burgers are considered an American food but are popular around the world."));

    popList.add(PopularFoodModal(
        images: "assets/images/sandwich.png",
        name: "Sandwich",
        icon: Icons.favorite,
        distance: "1.5 km",likes: "1.2 Likes",rating: 4,price: "Price:150/Rs",time: "25-30 min",description: "A sandwich is a dish typically consisting of meat, cheese or vegetables used as a filling between slices of bread, or placed atop a slice of bread; or, more generally, any dish in which bread serves as a container or wrapper for another food type, and allows it to be a finger food."));

    popList.add(PopularFoodModal(
        images: "assets/images/rolls.png",
        name: "Rolls",
        icon: Icons.favorite,
        distance: "0.5 km",likes: "3.2 Likes",rating: 3.5,price: "Price:240/Rs",time: "10-20 min",description: "A roti is a wrap style sandwich filled with either curried or sometimes stewed meats or vegetables wrapped inside a dhalpuri, paratha, or dosti roti."));
    popList.add(PopularFoodModal(
        images: "assets/images/pizzzaa.png",
        name: "Pizza",
        icon: Icons.favorite,
        distance: "0.5 km",likes: "0.5 Likes",rating: 5,price: "Price:220/Rs",time: "20-25 min",description: "Pizza, dish of Italian origin consisting of a flattened disk of bread dough topped with some combination of olive oil, oregano, tomato, olives, mozzarella or other cheese, and many other ingredients, baked quickly—usually, in a commercial setting, using a wood-fired oven heated to a very high temperature—and served hot ...27"));

    popList.add(PopularFoodModal(
        images: "assets/images/fries.png",
        name: "Fries",
        icon: Icons.favorite_border,
        distance: "3.0 km",likes: "2.2 Likes",rating: 4.3,price: "Price:350/Rs",time: "25-30 min",description: "French fries, side dish or snack typically made from deep-fried potatoes that have been cut into various shapes, especially thin strips. Fries are often salted and served with other items, including ketchup, mayonnaise, or vinegar.1"));
  ...
  dataList() {
    ...
    restList.add(RestaurantModal(
        ...
        name: "Burger King",
        icon: Icons.favorite,
        distance: "1.2 km",restaurantImage: "assets/restaurants/BurgerKingrest.png",description: "Founded in 1954, BURGER KING® is the second largest fast food hamburger chain in the world. The original HOME OF THE WHOPPER®, our commitment to premium ingredients, signature recipes, and family-friendly dining experiences is what has defined our brand for more than 50 successful years."));
    restList.add(RestaurantModal(
        images: "assets/restaurants/devados.png",
        name: "Devados",
        icon: Icons.favorite_border,
        distance: "3.0 km",restaurantImage: "assets/restaurants/restaurantdavava.png",description: "A good description highlights the food you serve, the atmosphere, the location, and the dining experience. These are simple things to list, but they can be hard to describe—especially in a way that appeals to guests."));
    restList.add(RestaurantModal(
        images: "assets/restaurants/kfc.png",
        name: "KFC",
        icon: Icons.favorite,
        distance: "1.5 km",restaurantImage: "assets/restaurants/kfcrestaurant.png",description: "KFC is a global chicken restaurant brand with a rich, decades-long history of success and innovation. It all started with one cook, Colonel Harland Sanders, who created a finger lickin' good recipe more than 75 years ago — a list of 11 secret herbs and spices scratched out on the back of his kitchen door."));
    restList.add(RestaurantModal(
        images: "assets/restaurants/pizzahut.png",
        name: "Pizza Hut",
        icon: Icons.favorite,
        distance: "0.5 km",restaurantImage: "assets/restaurants/pizzahutrest.png",description: "We have more than 16,000 restaurants and 350,000 team members in more than 100 countries. Whether it’s the original Stuffed Crust or putting a pizza in outer space, we never stop driving ourselves to deliver hot pizzas, fast every time – anywhere you want to enjoy it."));
               ...
               Padding(
                ...
                child: Row(
                  children: [
                    ...
                    GestureDetector(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => NearByRestaurantScreen(pages: restList[index]),));
                        },
                        child: const Text("View all",
                            style: TextStyle(
                                color: Colors.grey, fontWeight: FontWeight.bold)))
...
Widget get _nearByRestaurantWidget =>
    SizedBox(
      ...
      return GestureDetector(
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => RestaurantDetailScreen(pages: restList[index]),));
        },
        child: Container(
          height: 100,
          width: 120,
        ...
        return GestureDetector(
          onTap: (){
            Navigator.push(
                context,
                MaterialPageRoute(
                builder: (context) => PopularFoodScreen(pages: popList[index])));
...
class RestaurantModal {
  ...
  RestaurantModal(
      ...
      required this.name,
      required this.icon,
      required this.distance,required this.restaurantImage,required this.description});
}
class NearByRestaurantScreen extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    return SafeArea(child: Scaffold(
      appBar: AppBar(
        title: Text("Nearby Restaurant",style: TextStyle(fontWeight: FontWeight.bold),maxLines: 1,)
      ),
      body: Padding(
        padding: const EdgeInsets.only(left: 20,right: 20),
        child: Column(
              ...
              return Card(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Icon(restList[index].icon,color: Colors.orange,),
                    ),
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        Padding(
                          ...
                          child:Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(restList[index].name,style: const TextStyle(fontWeight: FontWeight.bold,overflow: TextOverflow.ellipsis),maxLines: 1,),
...
class RestaurantDetailScreen extends StatelessWidget{
  ...
  const RestaurantDetailScreen({super.key, required this.pages});

  Widget build(BuildContext context){
    return SafeArea(child: Scaffold(
      appBar: AppBar(
        title: Text("Restaurant",style: TextStyle(fontWeight: FontWeight.bold),maxLines: 1,)
      ),
      body: Padding(
        padding: const EdgeInsets.only(left: 20,right: 20),
        child: Column(
          children: [
            ...
            Row(
              children: [
                Expanded(child: Text("${pages.name}",style: const TextStyle(fontSize: 20,overflow: TextOverflow.ellipsis,fontWeight: FontWeight.bold),maxLines: 1,)),
                Container(
                  height: 30,
                    decoration: BoxDecoration(
                      shape: BoxShape.rectangle,
                    ...
                    child: const Row(
                      children: [
                        ...
                        Text("Open",style: TextStyle(fontSize: 15,color: Colors.orange),)
                      ],
                    )),
            ...
            SizedBox(height: 10,),
            Expanded(child: Text("${pages.description}",style: TextStyle(overflow: TextOverflow.ellipsis),maxLines: 4,)),
          ],
        ),
      ),
    ));
...
class PopularFoodModal {
  ...
  PopularFoodModal(
      {required this.images,
        required this.name,
        required this.icon,
        required this.distance,required this.likes,required this.rating,required this.price,required this.time,required this.description});
}
        ...
        body: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text("${pages.name}",style: const TextStyle(fontSize: 20,overflow: TextOverflow.ellipsis,fontWeight: FontWeight.bold),maxLines: 1,),
                    Row(
                    ...
                    Row(
                      children: [
                        Expanded(child: Padding(
                          ...
                          child: Text("${pages.price}",style: TextStyle(fontSize: 15),maxLines: 1,),
                        )),
              ...
              SizedBox(height: 10,),
              Text("Description",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,overflow: TextOverflow.ellipsis),maxLines: 1,),
              Expanded(child: Text("${pages.description}",style: TextStyle(overflow: TextOverflow.ellipsis),maxLines: 4,)),
              Spacer(),
              Padding(
